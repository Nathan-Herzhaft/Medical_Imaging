...
def infer(data_folder, model_folder="Grand_Challenge-Segmentation/runs", prediction_folder="Grand_Challenge-Segmentation/output"):
    """Run inference
...
if __name__ == "__main__":
    ...
    Usage:
        ...
        python Grand_Challenge-Segmentation/Segmentation.py infer --data_folder "Grand_Challenge-Segmentation/data/Validation" # run the inference pipeline
    """
    parser = argparse.ArgumentParser(description="Run a basic UNet segmentation baseline.")
    parser.add_argument(
        "mode", metavar="mode", default="train", choices=("train", "infer"), type=str, help="mode of workflow"
    )
    parser.add_argument("--data_folder", default="Grand_Challenge-Segmentation/data/Train", type=str, help="training data folder")
    parser.add_argument("--model_folder", default="Grand_Challenge-Segmentation/runs", type=str, help="model folder")
    ...
    if args.mode == "train":
        data_folder = args.data_folder or os.path.join("data", "Train")
        train(data_folder=data_folder, model_folder=args.model_folder)
    elif args.mode == "infer":
        data_folder = args.data_folder or os.path.join("data", "Validation")
